...
public class Check extends Command {
    ...
    private TextComponent tc1 = new TextComponent();
    ...
    private void check(UUID ut, CommandSender sender) {
        ...
        tc1.setText(Bungeesystem.normal + ChatColor.translateAlternateColorCodes('&', Bungeesystem.settings.getString("Check.stats")));
        tc.addExtra(tc1);
        ...
        if (!(sender instanceof ProxiedPlayer)) {
            ...
            h = "\n" + h + "\n";
            hoverArray.remove(0);
            sender.sendMessage(new TextComponent(Bungeesystem.Prefix + tc1.getText() + h + String.join("\n", hoverArray)));
